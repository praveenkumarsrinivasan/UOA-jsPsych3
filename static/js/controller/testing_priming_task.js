...
var testing_priming_task_exp = function(appModel) {
    ...
    var dot_block = {
        type: "text",
        text: appModel.dot,
        timing_post_trial: appModel.exp_configCollection.test_priming_timing_post_trial,
        cont_key: "mouse"
    };
    ...
    var bird_block1 = {
        ...
        is_html: true,
        //timing_response: appModel.exp_configCollection.test_priming_image_timing_response,
        timing_post_trial: appModel.exp_configCollection.test_priming_timing_post_trial,
    ...
    var slider_function_block = {
        ...
        timing_response: appModel.exp_configCollection.test_priming_slider_timing_response,
        timing_post_trial: appModel.exp_configCollection.test_priming_timing_post_trial
    };
    ...
    var images_block = {
        ...
        is_html: true,
        // timing_response: appModel.exp_configCollection.test_priming_image_timing_response+10000,
        timing_post_trial: appModel.exp_configCollection.test_priming_timing_post_trial,
        choices: [49, 50, 51]
        // response_ends_trial: false
    };
    ...
    var getAverageResponseTime = function() {
        ...
        var current_trial = 0;
        if (trials.length > 0) {
            current_trial = trials.length - appModel.exp_configCollection.test_priming_slider_timing_trials.length;
        }
